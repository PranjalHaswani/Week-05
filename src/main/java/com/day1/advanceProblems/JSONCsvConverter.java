...
public class JSONCsvConverter {
    ...
    public static void csvToJson(String csvFile, String jsonFile) {
        try {
            com.day1.advanceProblems.CSVReader csvReader = new CSVReader(new FileReader(csvFile));
    ...
    public static void main(String[] args) {
        String jsonFile = "D:\\Capgemini\\WEEK-05\\src\\main\\resources\\student.json";
        String csvFile = "D:\\Capgemini\\WEEK-05\\src\\main\\resources\\Student_.csv";
